...
class SequencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sequence" do
    assert_difference('Sequence.count') do
      post sequences_url, params: { sequence: { analysed: @sequence.analysed, sequence_name: @sequence.sequence_name } }
    end
  ...
  test "should update sequence" do
    patch sequence_url(@sequence), params: { sequence: { analysed: @sequence.analysed, sequence_name: @sequence.sequence_name } }
